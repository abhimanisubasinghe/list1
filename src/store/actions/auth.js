    ...
    return  dispatch => {
        ...
        .then(prasedRes => {
            ...
            if(!prasedRes.idToken){
                ...
                console.log('P!',prasedRes)
                dispatch(authStoreToken(prasedRes.idToken, prasedRes.expiresIn, prasedRes.refreshToken))
            ...
            return AsyncStorage.getItem("list1:auth:refreshToken")
                ...
                .then(parsedRes => {
                    if(parsedRes.id_token){
                        ...
                        dispatch(authStoreToken(parsedRes.id_token,parsedRes.expiresIn,parsedRes.refresh_token))
