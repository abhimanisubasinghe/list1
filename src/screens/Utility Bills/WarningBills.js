...
class WarningBills extends Component {
  ...
  handleChange = (val) => {
    ...
    render(){
      ...
      bills = bills.filter(item => {
        ...
        return (!item.paid && new Date(temp) >= new Date() && new Date(temp) <= tomorrow)
...
//export default WarningBills;
export default connect(mapStateToProps, mapDispatchToProps)(WarningBills);
